# 0.3.20 - Stable Web Viewer routing and sticker backlink lifecycle
...
- Pre-provision an already open Web Viewer during Obsidian layout restoration without revealing it, so the first user click does not perform the initialization reload.
